...
export function GoogleIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 48 48" {...props}>
      ...
      <path
        fill="#4CAF50"
        d="M24 44c5.2 0 10-2 13.6-5.2l-6.3-5.3a12 12 0 0 1-18.1-6L6.6 32.4A20 20 0 0 0 24 44z"
      />
      <path
        fill="#1976D2"
        d="M43.6 20.5H42V20H24v8h11.3a12 12 0 0 1-4.1 5.5l6.3 5.3C37 39 44 34 44 24c0-1.2-.1-2.4-.4-3.5z"
      />
    </svg>
  );
}
...
export function TikTokIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 48 48" {...props}>
      ...
      <path
        fill="#25F4EE"
        d="M30 12.5c.4 3.5 2.4 5.6 5.8 5.8v4c-2 0-3.9-.6-5.8-1.7v8.7c0 5.5-4 9.7-9.4 9.7-2.1 0-3.9-.6-5.4-1.7 7.1 1.3 10.8-3.3 10.8-9.7V18.7c1.9 1.1 3.8 1.7 5.8 1.7v-4c-.5-.1-1-.3-1.4-.4z"
        opacity=".9"
      />
      <path
        fill="#FE2C55"
        d="M32 14.5c.4 3.5 2.4 5.6 5.8 5.8v4c-2 0-3.9-.6-5.8-1.7v8.7c0 5.5-4 9.7-9.4 9.7s-9.4-4.2-9.4-9.7c0-5.4 4.4-9.7 9.8-9.5v4.2c-.4-.1-.9-.2-1.4-.2-2.7 0-4.9 2.3-4.9 5.1s2.2 5.1 4.9 5.1c2.7 0 5.1-2.2 5.1-5l.1-19.5h4.4c.3 2 1.5 3.7 3.2 4.6z"
      />
      <path
        fill="#fff"
        d="M31 13.5c.4 3.5 2.4 5.6 5.8 5.8v4c-2 0-3.9-.6-5.8-1.7v8.7c0 5.5-4 9.7-9.4 9.7s-9.4-4.2-9.4-9.7c0-5.4 4.4-9.7 9.8-9.5v4.2c-.4-.1-.9-.2-1.4-.2-2.7 0-4.9 2.3-4.9 5.1s2.2 5.1 4.9 5.1c2.7 0 5.1-2.2 5.1-5L25.8 10h4.4c.3 2 .5 2.5.8 3.5z"
      />
    </svg>
  );
}
...
export function FacebookIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 48 48" {...props}>
      ...
      <path
        fill="#fff"
        d="M27.5 25.5h4l.7-5.2h-4.7v-3.3c0-1.5.4-2.5 2.6-2.5h2.8V9.8c-.5-.1-2.1-.2-4-.2-4 0-6.7 2.4-6.7 6.9v3.8h-4.5v5.2h4.5V42h5.3V25.5z"
      />
    </svg>
  );
}
...
export function TrustpilotIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 48 48" {...props}>
      ...
      <path
        fill="#fff"
        d="M24 8l4.2 9.6 10.4.8-7.9 6.8 2.5 10.2L24 30l-9.2 5.4 2.5-10.2-7.9-6.8 10.4-.8z"
      />
    </svg>
  );
}
...
export function LoyaltyIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 48 48" {...props}>
      ...
      <path
        fill="#FFD700"
        d="M24 10l3.6 7.3 8 1.2-5.8 5.7 1.4 8L24 28.4l-7.2 3.8 1.4-8L12.4 18.5l8-1.2z"
      />
...
export function LinkedInIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 48 48" {...props}>
      ...
      <path
        fill="#fff"
        d="M15.1 18.6h-4.9v15.1h4.9V18.6zm-2.4-7.7a2.9 2.9 0 1 0 0 5.7 2.9 2.9 0 0 0 0-5.7zM38 25.7c0-4.7-2.5-6.9-5.9-6.9-2.7 0-3.9 1.5-4.6 2.5v-2.1h-4.9c.1 1.4 0 15.1 0 15.1h4.9v-8.4c0-.5 0-.9.2-1.2.4-.9 1.2-1.8 2.6-1.8 1.8 0 2.6 1.4 2.6 3.5v7.9H38v-8.6z"
      />
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 48 48" {...props}>
      ...
      <path
        ...
        stroke="#111"
        strokeWidth="1"
        d="M24 9.5c4.3 0 7.4 3.3 7.5 7.6 0 1.1-.1 2.2-.1 3.2.4.2.9.3 1.4.2.6-.1 1.2-.5 1.8-.5.7 0 1.6.5 1.6 1.3 0 1-1.4 1.5-2.3 1.9-.6.2-1.3.5-1.4.9-.1.5.3 1.1.6 1.7 1 1.8 2.6 3.7 5.1 4.3.5.1.7.4.6.9-.2 1-2 1.5-3.6 1.7-.4.1-.5.3-.6.7-.1.4-.2 1-.4 1.3-.2.3-.6.4-1.1.3-.7-.1-1.5-.3-2.5-.2-1 .1-1.8.6-2.6 1.2-1.1.8-2.2 1.6-4 1.6s-2.9-.8-4-1.6c-.8-.6-1.6-1.1-2.6-1.2-1-.1-1.8.1-2.5.2-.5.1-.9 0-1.1-.3-.2-.3-.3-.9-.4-1.3-.1-.4-.2-.6-.6-.7-1.6-.2-3.4-.7-3.6-1.7-.1-.5.1-.8.6-.9 2.5-.6 4.1-2.5 5.1-4.3.3-.6.7-1.2.6-1.7-.1-.4-.8-.7-1.4-.9-.9-.4-2.3-.9-2.3-1.9 0-.8.9-1.3 1.6-1.3.6 0 1.2.4 1.8.5.5.1 1 0 1.4-.2 0-1-.1-2.1-.1-3.2.1-4.3 3.2-7.6 7.5-7.6z"
      />
    </svg>
  );
}
